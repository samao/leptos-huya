...
pub fn HomePage() -> impl IntoView {
    view! {
        ...
        <div class="w-[980px] min-[1440px]:w-[1220px] mx-auto">
            ...
            <div class="h-[467px] min-[1440px]:h-[576px] mt-2 flex gap-x-2 justify-evenly bg-black/10 relative">
                <Player />
                <ul class="w-[129px] bg-black/40 min-[1440px]:w-[161px] flex flex-col justify-between *:rounded-md *:min-[1440px]:h-[91px] *:h-[71px] *:shadow-md *:shadow-black/60 *:place-content-center">
