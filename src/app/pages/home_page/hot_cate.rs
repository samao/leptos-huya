        ...
        Ok(HotCateData {
            ...
            <div class="flex gap-x-5 text-[14px] size-full **:[a]:hover:text-[#f80] **:[a]:duration-300">
                ...
                <div class="flex flex-col justify-between w-[290px]">
                    ...
                    <div class="overflow-hidden overflow-y-hidden px-3 text-left bg-white rounded-md hover:overflow-y-auto h-[310px] min-[1440px]:h-[350px]">
